...
import com.example.testdb.adapter.ViewPagerAdapterDichVu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(QuanLyDichVuActivity.this ,AddDichVuActivity.class));
            }
        });
        ViewPagerAdapterDichVu adapter=new ViewPagerAdapterDichVu(getSupportFragmentManager(),
