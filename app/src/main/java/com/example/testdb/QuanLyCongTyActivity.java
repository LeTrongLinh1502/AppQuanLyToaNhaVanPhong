...
public class QuanLyCongTyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quan_ly_cong_ty);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(QuanLyCongTyActivity.this ,AddCongTyActivity.class));
            }
        });
        ViewPagerAdapterCongTy adapter=new ViewPagerAdapterCongTy(getSupportFragmentManager(),
